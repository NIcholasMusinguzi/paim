...
export type NavItem = {
  label: string;
  to: string;
  icon: "grid" | "users" | "megaphone" | "cloud" | "chart" | "truck" | "file" | "gear" | "home" | "chat";
  match?: "exact" | "prefix";
};
...
const FARMER_NAV: NavItem[] = [
  { label: "Home", to: "/farmer", icon: "home", match: "prefix" },
  { label: "Posts", to: "/posts", icon: "megaphone", match: "prefix" },
  { label: "Ask for advice", to: "/advice", icon: "chat", match: "prefix" },
  { label: "Bids", to: "/bids", icon: "truck", match: "prefix" },
  { label: "Reports", to: "/reports", icon: "file", match: "prefix" },
...
const AGENT_NAV: NavItem[] = [
  { label: "Farmers", to: "/agent", icon: "users", match: "prefix" },
  { label: "Posts", to: "/posts", icon: "megaphone", match: "prefix" },
  { label: "Ask for advice", to: "/advice", icon: "chat", match: "prefix" },
  { label: "Bids", to: "/bids", icon: "truck", match: "prefix" },
  { label: "Reports", to: "/reports", icon: "file", match: "prefix" },
...
const BUYER_NAV: NavItem[] = [
  { label: "Open lots", to: "/buyer", icon: "truck", match: "prefix" },
  { label: "Posts", to: "/posts", icon: "megaphone", match: "prefix" },
  { label: "Ask for advice", to: "/advice", icon: "chat", match: "prefix" },
  { label: "Bids", to: "/bids", icon: "truck", match: "prefix" },
  { label: "Reports", to: "/reports", icon: "file", match: "prefix" },
